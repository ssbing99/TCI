...
class ConfigSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $sections_layout5 = json_encode(config('sections.layout_5'));
        $data = [
            'theme_layout' => 5,
            'font_color' => 'default',
            'layout_type' => 'wide',
            ...
            'app__name' => 'School Of Permaculture',
            'app__locale' => 'en',
