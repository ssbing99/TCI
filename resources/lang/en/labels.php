...
<b>Live</b> = Will be used with you Live PayPal credentials to make actual transaction with normal users with PayPal account.',
      ...
      'custom_js' => 'Custom JS',
      'teacher_commission_rate' => 'Instructor Commission Rate',
      ...
      'counter' => 'Counter',
      'counter_note' => '<b>Static</b> =  Manually add data for counter. Please enter exact text you want to display on frontend counter section,<br> <b>Database/Real</b> = It will take real data from database for all the fields (Students enrolled, Total Courses, Total Instructors)',
      'total_students' => 'Enter Total Students. Ex: 1K, 1Million, 1000 etc.',
      'total_courses' => 'Enter Total Courses. Ex: 1K, 1000 etc.',
      'total_teachers' => 'Enter Total Instructors. Ex: 1K, 1000 etc.',
  ...
  array (
    ...
    array (
      ...
      'no_lesson' => 'No lessons added for this course.',
      'go' => 'Go',
    ...
    array (
      ...
      'popular_teachers' => '<span>Popular</span> Instructors',
    ...
    array (
      ...
      array (
        ...
        'browse_our' => '<span>Browse Our</span>',
        'featured_courses' => 'Featured <span>Courses</span>',
