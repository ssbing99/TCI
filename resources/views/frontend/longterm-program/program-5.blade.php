    ...
    <div class="banner custom-banner-bg">
        <div class="container">
            <div class="page-heading text-sm-center">
                @lang('labels.frontend.program.title')
            </div>
        </div>
    </div>
                ...
                <div class="col-12">
                    <ul class="details clearfix">
                        ...
                        <li class="clearfix">
                            ...
                            @else
                            <div class="txtlabel clearfix">@lang('labels.frontend.program.price')
                                @if($course->free == 1)
                                    <span> {{trans('labels.backend.courses.fields.free')}}</span>
                                @else
                        ...
                        <li class="clearfix">
                            <div class="txtlabel clearfix">@lang('labels.frontend.program.category')
                                <span class="category">
                                    <a href="{{route('programs.category',['category'=>$course->category->slug])}}"
                        ...
                        <li class="clearfix">
                            ...
                            <div class="txtlabel clearfix">@lang('labels.frontend.program.teacher')
                        ...
                        <li class="clearfix"><div class="txtlabel clearfix">@lang('labels.frontend.program.ratings')
                                <span class="stars">
...
{{--                            <a href="cart.html" class="btn btn-theme btn-block btn-lg">BUY NOW</a>--}}
                            @if (!$purchased_course)
                                @if(auth()->check() && (auth()->user()->hasRole('student')) && (Cart::session(auth()->user()->id)->get( $course->id)))
                                    <button class="btn btn-theme btn-block btn-lg"
                                            type="submit">@lang('labels.frontend.program.added_to_cart')
                                    </button>
                                @elseif(!auth()->check())
                                    @if($course->free == 1)
                                        <a id="openLoginModal"
                                           class="btn btn-theme btn-block btn-lg text-center text-white text-uppercase"
                                           data-target="#myModal" href="#">@lang('labels.frontend.program.get_now') </a>
                                    @else
                                        <a id="openLoginModal"
                                           class="btn btn-theme btn-block btn-lg text-center text-white text-uppercase"
                                           data-target="#myModal" href="#">@lang('labels.frontend.program.buy_now') </a>

                                        <a id="openLoginModal"
                                           class="btn btn-theme btn-block btn-lg bg-dark text-center text-white text-uppercase"
                                           data-target="#myModal" href="#">@lang('labels.frontend.program.add_to_cart') <i
                                    ...
                                    @if($course->free == 1)
                                        <form action="{{ route('cart.getnow') }}" method="POST">
                                            ...
                                            <button class="btn btn-theme btn-block btn-lg text-center text-white text-uppercase"
                                                    href="#">@lang('labels.frontend.program.get_now')</button>
                                        </form>
                                    @else
                                        <form action="{{ route('cart.checkout') }}" method="POST" class="mb-2">
                                            ...
                                            <input type="hidden" name="amount" value="{{($course->free == 1) ? 0 : $course->price}}"/>
                                            <button class="btn btn-theme btn-block btn-lg text-center text-white text-uppercase"
                                                    href="#">@lang('labels.frontend.program.buy_now')</button>
                                        </form>
                                        <form action="{{ route('cart.addToCart') }}" method="POST">
                                            ...
                                            <button type="submit"
                                                    class="btn btn-theme btn-block btn-lg bg-dark text-center text-white text-uppercase ">
                                                @lang('labels.frontend.program.add_to_cart') <i
                                ...
                                @else
                                    <h6 class="alert alert-danger"> @lang('labels.frontend.program.buy_note')</h6>
                                @endif
                            @else
                                ...
                                @if($continue_course)
                                    <a href="{{route('lessons.show',['course_id' => $course->id,'slug'=>$continue_course->model->slug])}}"
                                       class="btn btn-theme btn-block btn-lg text-center text-white text-uppercase">
                                        ...
                                        @lang('labels.frontend.program.continue_course')
                ...
                <div class="col-12">
                    <div class="featureshead clearfix">@lang('labels.frontend.program.course_features')</div>
                </div>
            </div>
            <div class="row mtb-15 clearfix">
                <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                    <div class="featuregrid clearfix">
                        <p><i class="fa fa-file-text-o"></i> @lang('labels.frontend.program.lectures')<span>{{$course->chapterCount()}}</span></p>
                    </div>
                </div>
                <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                    <div class="featuregrid clearfix">
                        <p><i class="fa fa-puzzle-piece"></i> @lang('labels.frontend.program.quizzes')<span>{{$course->quizCount()}}</span></p>
                    </div>
                </div>
                <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                    <div class="featuregrid clearfix">
                        <p><i class="fa fa-clock-o"></i> @lang('labels.frontend.program.duration')<span>{{$course->duration > 0 ? $course->duration : '0'}} @lang('labels.frontend.layouts.partials.hours')</span></p>
                    </div>
                </div>
                <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                    <div class="featuregrid clearfix">
                        <p><i class="fa fa-graduation-cap"></i> @lang('labels.frontend.program.skill_level')<span>{{isset($course->skill_level) ? mb_strtoupper($course->skill_level) : '-'}}</span></p>
                    </div>
                </div>
                <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                    <div class="featuregrid clearfix">
                        <p><i class="fa fa-globe"></i> @lang('labels.frontend.program.language')<span>English</span></p>
                    </div>
                </div>
                <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                    <div class="featuregrid clearfix">
                        <p><i class="fa fa-user"></i> @lang('labels.frontend.program.students')<span>{{ $course->students()->count() }}</span></p>
                    </div>
                </div>
                <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                    <div class="featuregrid clearfix">
                        <p><i class="fa fa-certificate"></i> @lang('labels.frontend.program.certificate')<span>Yes</span></p>
                    </div>
                </div>
                <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                    <div class="featuregrid clearfix">
                        <p><i class="fa fa-file-text"></i> @lang('labels.frontend.program.assessments')<span>{{$course->quizCount() > 0? 'Yes':'No'}}</span></p>
                    </div>
                </div>
            </div>
            ...
            <div class="row mtb-15 clearfix">
                <div class="col-12 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                    <div class="grey-bg p-20 clearfix">
                        <div class="sectiontitle clearfix">@lang('labels.frontend.program.curriculum')</div>
                        @if(count($lessons) == 0)

                            <ul class="lecture clearfix">
                                <li><span>@lang('labels.frontend.program.no_lesson')</span></li>
                            </ul>
                        @endif
                        @if(count($lessons)  > 0)
                            @php $count = 0; @endphp
...
{{--                                                            {{$lesson->model->title}}</a></span><span class="duration font-weight-bold">@lang('labels.frontend.program.completed')</span>--}}
{{--                                                </li>--}}
                                        @else
                                    ...
                                    @endif
                                        @php
                                            ...
                                            if($lesson->model_type == 'App\Models\Test'){
                                                $auth_display .=' <span class="badge badge-success">'.trans('labels.frontend.program.test').'</span>';
                                            }

                                            if($lesson->model->live_lesson){
                                                $auth_display .=' <span class="badge badge-success">'.trans('labels.frontend.program.live_lesson').'</span>';
                                            }
                                        ...
                                        @if($lesson->model->live_lesson)
                                            <div class="card mt-3 border">
                                                <div class="card-header">
                                                    <h6 class="text-black-50"><b>@lang('labels.frontend.program.available_slots')</b></h6>
                                                </div>
                                                ...
                                                @forelse($lesson->model->liveLessonSlots as $slot)
                                                    ...
                                                    <li>
                                                        @lang('labels.frontend.program.date') {{ $slot->start_at->format('d-m-Y h:i A') }}
                                                    </li>
                                                @empty
                                                @endforelse
                                                    </ul>
...
{{--                        </ul>--}}
                    ...
                    <div class="featureshead clearfix">@lang('labels.frontend.program.ratings_reviews')</div>
                                    ...
                                    <div class="ratingsbox clearfix">
                                        ...
                                        <div class="content">
                                            ...
                                            @if(auth()->check() && ($item->user_id == auth()->user()->id))
                                                <div>
                                                    <a href="{{route('programs.review.edit',['id'=>$item->id])}}"
                                                       class="mr-2">@lang('labels.general.edit')</a>
                                                    <a href="{{route('programs.review.delete',['id'=>$item->id])}}"
                    ...
                    @else
                        <h6> @lang('labels.frontend.program.no_reviews_yet')</h6>
                    @endif
                    ...
                    @if ($purchased_course)
                        @if(isset($review) || ($is_reviewed == false))
                            @php
                                if(isset($review)){
                                    $route = route('programs.review.update',['id'=>$review->id]);
                                }else{
                                   $route = route('programs.review',['id'=> $course->id]);
                                }
                            @endphp
                            <div class="row clearfix">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <h5 style="color: #333;">@lang('labels.frontend.program.add_reviews')</h5>
                                    <div class="clearfix"></div>
                                    <form class="mtb-30" action="{{$route}}" method="POST" data-lead="Residential">
                                        ...
                                        <div class="form-group">
                                            <label>@lang('labels.frontend.program.your_rating'): </label>
                                            <div class="rating">
                                                <label>
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control @if($errors->has('review')) border-bottom border-danger @endif" name="review" id="review" placeholder="@lang('labels.frontend.program.message')">@if(isset($review)){{$review->content}} @endif</textarea>
                                            @if($errors->has('review'))
                                                <span class="help-block text-danger">{{ $errors->first('review', ':message') }}</span>
                                            @endif
                                        </div>
                                        <button type="submit" name="submit" id="submit" class="btn btn-primary btn-lg" value="Submit">@lang('labels.frontend.program.add_review_now')</button>
                                    </form>
                                </div>
                            </div>
