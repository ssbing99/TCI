    ...
    <section>
        <div class="container">
            <div class="col-12">
                ...
                <a href="{{ route('submission.attachment.sequence', ['assignment_id' => $assignment->id, 'submission_id' => $submission->id, 'resetPic' => 1]) }}" class="btn btn-primary btn-padding br-24 mb-2">Reset</a>
                <div id="imageListId">
