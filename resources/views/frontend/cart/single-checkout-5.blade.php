                                ...
                                <div class="card clearfix">
                                    ...
                                    <div class="card-body">
                                        <p class="course-txt clearfix">
                                            ...
                                            Today
                                            <span>Course Price(Without Skype)</span>
                                            {{$appCurrency['symbol'].' '.$course->price}}
{{--                                            <i class="fa fa-usd"></i> 2295.00--}}
                                            <span>Course Price(With Skype)</span>
                                            {{$appCurrency['symbol'].' '.$course->price_skype}}
{{--                                            <i class="fa fa-usd"></i> 2365.00--}}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="withoutSkype"> {{$appCurrency['symbol'].' '.$course->price}}(Without Skype)</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="coursePrice" id="withSkype" value="withSkype">
                                        <label class="form-check-label" for="withSkype">{{$appCurrency['symbol'].' '.$course->price_skype}}(With Skype)</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control required" id="giftName" name="giftName" placeholder="">
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label for="cc-number">Recipeint Email</label>
                                        <input type="text" class="form-control required" id="giftEmail" name="giftEmail" placeholder="">
                                    </div>
                                </div>
...
@push('after-scripts')
    ...
    <script>
        ...
        function onSubmit(_this) {
            ...
            @if($gift)
                var recname= document.getElementById('giftName');
                var recemail= document.getElementById('giftEmail');
