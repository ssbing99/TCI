...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.assignments.rearrangement.create',['assignment_id'=>$assignment_id]], 'files' => true,]) !!}
    {!! Form::hidden('model_id',0,['id'=>'assignment_id']) !!}

    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left mb-0">Create Rearrangement</h3>
            <div class="float-right">
                <a href="{{ route('admin.assignments.rearrangement.list', ['assignment_id'=>$assignment_id]) }}"
