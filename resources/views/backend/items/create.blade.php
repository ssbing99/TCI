...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left">@lang('labels.backend.items.create')</h3>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12 col-lg-6 form-group">
                    ...
                    {!! Form::text('title', old('title'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.items.fields.title'), 'required' => true]) !!}
                </div>
                <div class="col-12 col-lg-6 form-group">
...
{{--            </div>--}}
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4 form-group">
                    {!! Form::label('item_image',  trans('labels.backend.items.fields.item_image'), ['class' => 'control-label']) !!}
                    {!! Form::file('item_image',  ['class' => 'form-control', 'required' => true, 'accept' => 'image/jpeg,image/gif,image/png']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 form-group">
                        ...
                        {!! Form::select('discount_type', ['perc' => 'Percentage','fix' => 'Fixed Price'],null,['class' => 'form-control', 'placeholder' => 'Select One','id'=>'discount_type' ]) !!}
                    </div>
