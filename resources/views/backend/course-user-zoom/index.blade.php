...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline">Zoom Schedule</h3>
...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            var route = '{{route('admin.course-user-zoom.get_data')}}';


            @php
            $show_deleted = (request('show_deleted') == 1) ? 1 : 0;
            $course_id = (request('course_id') != "") ? request('course_id') : 0;
            $route = route('admin.course-user-zoom.get_data',['show_deleted' => $show_deleted,'course_id' => $course_id]);
            @endphp
...
{{--            @endif--}}
            ...
            $(document).on('change', '#course_id', function (e) {
                ...
                window.location.href = "{{route('admin.live-lesson-slots.index')}}" + "?course_id=" + course_id
            });
        });
