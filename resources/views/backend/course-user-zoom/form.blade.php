<div class="row">
    <div class="col-12 col-lg-6 form-group">
        ...
        {!! Form::text('course', $course->title, ['class' => 'form-control', 'required' => false, 'readonly' => true]) !!}
{{--        {!! Form::select('course_id', $course,  (request('lesson_id')) ? request('lesson_id') : old('lesson_id'), ['class' => 'form-control select2']) !!}--}}
    </div>
    <div class="col-12 col-lg-6 form-group">
...
<div class="row">
    <div class="col-12 col-lg-6 form-group">
        ...
        {!! Form::datetimeLocal('start_at', $courseStudentZoom?$courseStudentZoom->start_at->format('Y-m-d\TH:i'):old('start_at'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.live_lesson_slots.fields.date_of_slot'),'required' => true, 'min' => $courseStudentZoom ? $courseStudentZoom->start_at->format('Y-m-d\TH:i'): '']) !!}
    </div>
    <div class="col-12 col-lg-6 form-group">
