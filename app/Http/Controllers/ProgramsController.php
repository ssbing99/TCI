...
class ProgramsController extends Controller
{
    ...
    public function all(Request $request)
    {
        ...
        $view_path = returnPathByTheme($this->path.'.longterm-program.index', 5,'-');
    ...
    public function show($course_slug)
    {
        ...
        $view_path = returnPathByTheme($this->path.'.longterm-program.program', 5,'-');
    ...
    public function updateReview(Request $request)
    {
        ...
        if ($review) {
            ...
            return redirect()->route('programs.show', ['slug' => $review->reviewable->slug]);
        }
        return abort(404);
    ...
    public function deleteReview(Request $request)
    {
        ...
        if ($review) {
            ...
            $review->delete();
            return redirect()->route('programs.show', ['slug' => $slug]);
        }
        return abort(404);
    }
}
