...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.dashboard',compact('purchased_courses','students_count','recent_reviews','threads','purchased_bundles','teachers_count','courses_count','recent_orders','recent_contacts','pending_orders','purchased_items'));
    }
    ...
    public function studentIndex()
    {
        ...
        $user = auth()->user();
        return view('frontend.dashboard.student',compact('purchased_courses','students_count','recent_reviews','threads','purchased_bundles','teachers_count','courses_count','recent_orders','recent_contacts','pending_orders','purchased_items','user'));
    }
    ...
    public function instructorIndex()
    {
        ...
        if (\Auth::check()) {
            ...
            if(auth()->user()->hasRole('teacher')){
                //IF logged in user is teacher
                $all_courses = Course::whereHas('teachers', function ($query) {
                    $query->where('user_id', '=', auth()->user()->id);
                })->get();
                $all_with_trashed = Course::withTrashed()->whereHas('teachers', function ($query) {
                    $query->where('user_id', '=', auth()->user()->id);
                })->get();
